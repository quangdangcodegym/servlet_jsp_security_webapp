...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		System.out.println(this.getClass() + " sectionInfo: " + request.getSession().getId());
		
		System.out.println(this.getClass() + " servletPath: " + servletPath + " loginedUser: " + loginedUser);
		...
		if (SecurityUtils.isSecurityPage(request)) {
			...
			if (loginedUser == null) {
				...
				System.out.println(SecurityFilter.class + " requestUri: " + requestUri + " redirectId:" + redirectId );
